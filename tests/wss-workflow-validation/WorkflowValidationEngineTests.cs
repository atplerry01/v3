...
using WfTemplate = Whycespace.System.Midstream.WSS.Models.WorkflowTemplate;
using WfTemplateStep = Whycespace.System.Midstream.WSS.Models.WorkflowTemplateStep;
...
public class WorkflowValidationEngineTests
{
    ...
    public WorkflowValidationEngineTests()
    {
        ...
        var registryStore = new WorkflowRegistryStore();

        var graphEngine = new WorkflowGraphEngine();
        var definitionEngine = new WorkflowDefinitionEngine(definitionStore);
