...
public sealed class DeviceTrustEngine : IEngine
{
    ...
    public Task<EngineResult> ExecuteAsync(EngineContext context)
    {
        ...
        var deviceType = context.Data.GetValueOrDefault("deviceType") as string ?? "";
        var operatingSystem = context.Data.GetValueOrDefault("operatingSystem") as string ?? "";
        ...
        var previousDeviceUsageCount = ResolveInt(context.Data.GetValueOrDefault("previousDeviceUsageCount")) ?? 0;
        var deviceAgeDays = ResolveInt(context.Data.GetValueOrDefault("deviceAgeDays")) ?? 0;
