...
public sealed class WorkforcePerformanceEngine : IEngine, IIntelligenceEngine<EngineContext, EngineResult>
{
    ...
    public string EngineName => "WorkforcePerformance";
    ...
    public IntelligenceResult<EngineResult> Execute(IntelligenceContext<EngineContext> context)
    {
        ...
        if (command is null)
            return IntelligenceResult<EngineResult>.Fail("Invalid performance command: missing required fields",
