...
public sealed class VaultProfitAnalyticsEngine : IEngine, IIntelligenceEngine<EngineContext, EngineResult>
{
    public string Name => "VaultProfitAnalytics";
    public string EngineName => "VaultProfitAnalytics";
    ...
    public IntelligenceResult<EngineResult> Execute(IntelligenceContext<EngineContext> context)
    {
        ...
        if (command is null)
            return IntelligenceResult<EngineResult>.Fail("Invalid profit analytics command: missing required fields",
