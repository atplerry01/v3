...
public sealed class VaultBalanceAnalyticsEngine : IIntelligenceEngine<VaultBalanceAnalyticsInput, VaultBalanceAnalyticsResult>
{
    public string EngineName => "VaultBalanceAnalytics";

    public IntelligenceResult<VaultBalanceAnalyticsResult> Execute(IntelligenceContext<VaultBalanceAnalyticsInput> context)
    {
        var startedAt = DateTimeOffset.UtcNow;
        var command = context.Input.Command;
        var ledgerEntries = context.Input.LedgerEntries;

        var validationError = Validate(command);
        if (validationError is not null)
        {
            var failResult = new VaultBalanceAnalyticsResult(
            ...
            return IntelligenceResult<VaultBalanceAnalyticsResult>.Fail(validationError,
        ...
        var result = new VaultBalanceAnalyticsResult(
            AnalyticsId: command.AnalyticsId,
            VaultId: command.VaultId,
        ...
        return IntelligenceResult<VaultBalanceAnalyticsResult>.Ok(result,
            IntelligenceTrace.Create(EngineName, context.CorrelationId, startedAt));
    }
