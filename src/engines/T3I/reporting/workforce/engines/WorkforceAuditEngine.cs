using Whycespace.Engines.T3I.Reporting.Workforce.Models;
using Whycespace.Engines.T3I.Shared;
namespace Whycespace.Engines.T3I.Reporting.Workforce.Engines;
...
public sealed class WorkforceAuditEngine : IEngine, IIntelligenceEngine<EngineContext, EngineResult>
{
    public string Name => "WorkforceAudit";
    public string EngineName => "WorkforceAudit";
    ...
    public IntelligenceResult<EngineResult> Execute(IntelligenceContext<EngineContext> context)
    {
        ...
        if (workforce is null)
            return IntelligenceResult<EngineResult>.Fail("Missing workforce aggregate data", IntelligenceTrace.Create(EngineName, context.CorrelationId, startedAt));
