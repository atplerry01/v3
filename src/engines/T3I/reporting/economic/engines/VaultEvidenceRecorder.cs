...
public sealed class VaultEvidenceRecorder : IIntelligenceEngine<RecordVaultEvidenceCommand, VaultEvidenceRecord>
{
    public string EngineName => "VaultEvidence";

    public IntelligenceResult<VaultEvidenceRecord> Execute(IntelligenceContext<RecordVaultEvidenceCommand> context)
    {
        var startedAt = DateTimeOffset.UtcNow;
        var result = RecordEvidence(context.Input);
        return IntelligenceResult<VaultEvidenceRecord>.Ok(result, IntelligenceTrace.Create(EngineName, context.CorrelationId, startedAt));
    }
