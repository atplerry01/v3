...
public sealed class PolicyConflictAnalysisEngine : IIntelligenceEngine<PolicyConflictAnalysisInput, PolicyConflictAnalysisResult>
{
    public string EngineName => "PolicyConflictAnalysis";

    public IntelligenceResult<PolicyConflictAnalysisResult> Execute(IntelligenceContext<PolicyConflictAnalysisInput> context)
    {
        var startedAt = DateTimeOffset.UtcNow;
        var result = AnalyzeConflicts(context.Input);
        return IntelligenceResult<PolicyConflictAnalysisResult>.Ok(result, IntelligenceTrace.Create(EngineName, context.CorrelationId, startedAt));
    }
