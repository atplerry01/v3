...
public sealed class PolicyAuditEngine : IIntelligenceEngine<PolicyAuditInput, PolicyAuditRecord>
{
    public string EngineName => "PolicyAudit";

    public IntelligenceResult<PolicyAuditRecord> Execute(IntelligenceContext<PolicyAuditInput> context)
    {
        var startedAt = DateTimeOffset.UtcNow;
        var result = CreateAuditRecord(context.Input);
        return IntelligenceResult<PolicyAuditRecord>.Ok(result, IntelligenceTrace.Create(EngineName, context.CorrelationId, startedAt));
    }
