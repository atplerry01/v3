...
public sealed class PolicyDiffEngine : IIntelligenceEngine<PolicyDiffInput, PolicyDiffResult>
{
    public string EngineName => "PolicyDiff";

    public IntelligenceResult<PolicyDiffResult> Execute(IntelligenceContext<PolicyDiffInput> context)
    {
        var startedAt = DateTimeOffset.UtcNow;
        var result = GenerateDiff(context.Input);
        return IntelligenceResult<PolicyDiffResult>.Ok(result, IntelligenceTrace.Create(EngineName, context.CorrelationId, startedAt));
    }
