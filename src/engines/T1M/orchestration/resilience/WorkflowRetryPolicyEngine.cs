...
{
    private readonly Whycespace.Engines.T1M.Shared.IWorkflowRetryStore? _retryStore;

    public WorkflowRetryPolicyEngine() { }

    public WorkflowRetryPolicyEngine(Whycespace.Engines.T1M.Shared.IWorkflowRetryStore retryStore)
    {
