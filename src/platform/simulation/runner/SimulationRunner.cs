namespace Whycespace.Platform.Simulation.Runner;
...
using Whycespace.Platform.Simulation.Dispatch;
using Whycespace.Platform.Simulation.FaultInjection;
...
public sealed class SimulationRunner
{
    ...
    private async Task ExecuteSingleWorkflowAsync()
    {
        ...
        var dispatcher = new SimulationEngineDispatcher(_registry);
    ...
    private static EventEnvelope? GenerateWorkflowEvent(
