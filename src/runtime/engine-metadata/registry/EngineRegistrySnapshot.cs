...
{
    public IReadOnlyDictionary<EngineTier, IReadOnlyList<EngineRegistryDescriptor>> ByTier { get; }
    public int TotalCount { get; }

    internal EngineRegistrySnapshot(IReadOnlyList<EngineRegistryDescriptor> descriptors)
    {
        ...
        ByTier = Enum.GetValues<EngineTier>()
            .ToDictionary(
                tier => tier,
                tier => (IReadOnlyList<EngineRegistryDescriptor>)descriptors
                    .Where(d => d.Tier == tier)
